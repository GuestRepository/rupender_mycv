...
<?php $__env->startSection('title', 'CV Create'); ?>
                            ...
                            <form id="wizard-form" method="post" action="">
                                ...
                                <div class="step" data-step="1">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's email id">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's mobile number">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's date of birth">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" class="form-control" placeholder="Recipient's date of birth">
                                    </div>
                                ...
                                <div class="step" data-step="2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's pin number">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's country name">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's state name">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's city name">
                                    </div>
                                ...
                                <div class="step" data-step="3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's linkedin id">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Recipient's facebook id">
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="step" data-step="5">
                                    ...
                                    <div class="row" id="accordion-body-Exchange">
                                        ...
                                        <input type="text" name="user_id" value="<?php echo e((Auth::user()->id)); ?>">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                        ...
                        $("#accordion-body-Exchange").append(`
                            ...
                            <div class="row" id="companyExperience-remo">
                                <div class="col-md-12">
                                    <div class="card shadow">  
                                        <div class="card-header">
                                        <a href="#" class="close-icon delete-ExchangeName text-danger"><img src="<?php echo e(asset('assets/cv-img/trash-icon.svg')); ?>" style="height:30px; width:30px;"></a> 
                                        </div>
                                        <div class="card-body">  
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
...
<?php echo $__env->make('layouts.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practice-code\mycv\resources\views/canva/create.blade.php ENDPATH**/ ?>