			...
			<div class="container">
		      ...
		      <div class="col-lg-3 sidebar">
		        ...
		        <div class="sidebar-box ftco-animate">
		        	<div class="">
			        	<a href="#" class="company-wrap"><img src="{{asset('assets/images/company-1.jpg')}}" class="img-fluid" alt="Colorlib Free Template"></a>
			        	<div class="text p-3">
		        ...
		        <div class="sidebar-box ftco-animate">
		        	<div class="">
			        	<a href="#" class="company-wrap"><img src="{{asset('assets/images/company-2.jpg')}}" class="img-fluid" alt="Colorlib Free Template"></a>
			        	<div class="text p-3">
		        ...
		        <div class="sidebar-box ftco-animate">
		        	<div class="">
			        	<a href="#" class="company-wrap"><img src="{{asset('assets/images/company-3.jpg')}}" class="img-fluid" alt="Colorlib Free Template"></a>
			        	<div class="text p-3">
		        ...
		        <div class="sidebar-box ftco-animate">
		        	<div class="">
			        	<a href="#" class="company-wrap"><img src="{{asset('assets/images/company-4.jpg')}}" class="img-fluid" alt="Colorlib Free Template"></a>
			        	<div class="text p-3">
			        		<h3><a href="#">IT Programming INC</a></h3>
			        		<p><span class="number">700</span> <span>Open position</span></p>
			        	</div>
