...
<link rel="stylesheet" href="{{asset('assets/admin/admin-css/bootstrap.min.css')}}">
  <script src="{{asset('assets/admin/admin-css/jquery.slim.min.js')}}"></script>
  <script src="{{asset('assets/admin/admin-css/popper.min.js')}}"></script>
  <script src="{{asset('assets/admin/admin-css/bootstrap.bundle.min.js')}}"></script>

<!------ Include the above in your HEAD tag ---------->

<link href="{{asset('assets/admin/admin-css/font-awesome.min.css')}}" rel="stylesheet">

<link rel="stylesheet" href="{{asset('assets/admin/admin-css/style.css')}}">
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto sidenav" id="navAccordion">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#"> <i class="fa fa-user fa-lg"></i>  {{ Auth::user()->name }}</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('admin.applied.jobs.index')}}"> <i class="fa fa-jobs fa-lg"></i> Applied Jobs </a>
      </li>
      <li class="nav-item active">
