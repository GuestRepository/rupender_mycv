                    ...
                    <form id="myForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="number" class="form-control mt-2" name="phone" id="Number"  value="{{ !empty($userProfile->phone) ? $userProfile->phone : 'not Phone number' }}"  placeholder="Enter Phone number">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <img src="{{ URL:: asset('studentImage/'.$userProfile->userimage) }}" id="imagePreview" alt="Image Preview"
                                    style="width:200px; height:180px;">
                                <input type="file" id="imageInput"  name="userimage" class="form-control mt-2">

                                @else
                                <img src="{{ asset('assets/images/person_1.jpg') }}" id="imagePreview" alt="Image Preview"
                                    style="width:200px; height:180px;">
                                <input type="file" id="imageInput"  name="userimage" class="form-control mt-2">
                                @endif
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" id="Qualification"
                                    name="higher_qualification" value="{{ !empty($userProfile->higher_qualification) ? $userProfile->higher_qualification : 'Enter qualification MCA,BCA,BTECH' }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="12TH" name="qualification12th" value="{{ !empty($userProfile->qualification12th) ? $userProfile->qualification12th : 'Enter after 10th CBSC..' }}">
                            ...
                            <div class="form-group col-4">
                                ...
                                value="{{ !empty($userProfile->qualification10th) ? $userProfile->qualification10th : 'Enter after 10th CBSC..' }}">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" id="country" placeholder="Enter country name"
                                    name="country" value="{{ !empty($userProfile->country) ? $userProfile->country : 'Enter country name' }}">
